...
export default function TeachersList() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setTeachers([
        { id: 1, name: 'Dupont', firstName: 'Jean', email: 'jean.dupont@univ.fr', department: 'Informatique' },
        { id: 2, name: 'Martin', firstName: 'Marie', email: 'marie.martin@univ.fr', department: 'Génie Civil' },
        { id: 3, name: 'Bernard', firstName: 'Pierre', email: 'pierre.bernard@univ.fr', department: 'Informatique' }
      ]);
      setLoading(false);
    }, 1000);
  }, []);
