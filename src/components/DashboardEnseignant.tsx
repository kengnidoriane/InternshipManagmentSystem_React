  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-login-gradient">
      <div className="bg-white bg-opacity-80 shadow-lg rounded-lg p-8 max-w-lg w-full mt-10">
        <h1 className="text-3xl font-bold text-[#58693e] mb-6 text-center">Bienvenue, enseignant !</h1>
        <div className="mb-6 text-center">
          <p className="text-lg text-[#B79056] font-semibold">Résumé du profil</p>
        ...
        <div className="mb-6">
          <p className="text-lg font-semibold text-[#58693e] mb-2">Étudiants à suivre</p>
        ...
        <div className="flex flex-col gap-4 mt-8">
          <button className="bg-[#58693e] text-white font-semibold py-2 px-6 rounded hover:bg-[#40512d] transition-colors">Voir tous les étudiants</button>
          <button className="bg-[#B79056] text-white font-semibold py-2 px-6 rounded hover:bg-[#a07b3d] transition-colors">Valider un stage</button>
